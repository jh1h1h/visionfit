...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull AppCompatButton btnLogin, @NonNull CheckBox checkBoxRememberMe,
      @NonNull TextInputEditText email, @NonNull AppCompatImageView imageView,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayoutCompat) rootView, btnLogin, checkBoxRememberMe,
          email, imageView, password, progressBar, registerNow, txtForgotPassword);
    }
