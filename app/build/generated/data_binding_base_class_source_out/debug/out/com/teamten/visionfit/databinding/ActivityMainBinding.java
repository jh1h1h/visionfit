...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull Button cameraButton, @NonNull Button dailychallengeButton,
      @NonNull ConstraintLayout greeting, @NonNull Button leaderboardButton,
      @NonNull Button mystatsButton, @NonNull Button rewardsButton,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button mystatsButton = ViewBindings.findChildViewById(rootView, id);
      if (mystatsButton == null) {
        break missingId;
      }

      id = R.id.rewardsButton;
      Button rewardsButton = ViewBindings.findChildViewById(rootView, id);
