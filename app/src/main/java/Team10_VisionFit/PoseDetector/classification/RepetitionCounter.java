...
public class RepetitionCounter {
  ...
  private static final float DEFAULT_EXIT_THRESHOLD = 4f; //Originally 4, Only checks AFTER entered a pose, so its actually checking how unlike the entered pose is, which would mean exited the pose and completed 1 rep
