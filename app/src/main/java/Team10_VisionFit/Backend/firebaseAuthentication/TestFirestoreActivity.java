...
public class TestFirestoreActivity extends AppCompatActivity {
    ...
    public static void addDataToFirestore(String uid, String username, String country, String dob, int streak, int pushupToday,
                                   ...
                                   boolean hasCompletedPushupsChallengeToday,
                                          boolean streakChange, int current_points, int lifetime_points, int num_rewards1, int num_rewards2, int num_rewards3, int num_rewards4, String purchaseHistory) {
        ...
        hasCompletedPushupsChallengeToday,
                streakChange, current_points, lifetime_points, num_rewards1, num_rewards2, num_rewards3, num_rewards4, purchaseHistory);
